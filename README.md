...
拆一份材料，然后**逼你拿自己的生意去对**，最后产出你自己的版本。

不是摘要，不是笔记，不是"我读懂了"。终点只认两样东西：
...
**先定生意，再定 Agent。** 大部分人反过来——先挑工具，再想拿它干嘛，然后收藏夹里躺着三百个再也不会打开的东西。

**抄的不是流程，是流程背后那门生意的假设。** 一份写得再专业的方法论，换一门生意可能整套是反的。所以每次都得拿自己的业务逐环去对——**那一步没有人能替你做，AI 也不行。**

**没有「一张只有你有的图」和「一份还缺什么的清单」，这一轮就是白吸。**
...
<div align="center">
<sub>如果它让你少收藏了一个再也不会打开的 skill，点个 ⭐ 就是最好的反馈</sub>
</div>
